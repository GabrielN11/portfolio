        ...
        <StyledAbout mode={mode} id='about' visible={visible} ref={aboutref}>
            ...
            <StyledAboutText>
                ...
                <StyledText className={show < 4 ? styles.opacity : styles.visible}>
                    {english ? 
                    "I'm a 24 years old web developer graduated in Analysis and systems development, I live in São Paulo, SP, Brazil. I have a thirst for knowledge, improving and enhancing my skills more and more to the world of technology and transform this knowledge and practice in results that can help, please and carve out everyone who browses my projects. I'm currently practicing and improving myself at developing intuitive, responsive, objective, functional and efficient pages with modern technologies that can offer pleasant interfaces and user experience." : 
                    'Sou um desenvolvedor web de 24 anos formado em Análise e Desenvolvimento de Sistemas, resido na capital de São Paulo, Brasil. Sou entusiasmado para aprender, aprimorar e me adaptar cada vez mais ao mundo da tecnologia e transformar todo esse conhecimento em resultados práticos que possam ajudar, agradar e conquistar as pessoas que buscam navegar pelos meus projetos. Atualmente costumo praticar e me aprimorar no desenvolvimento de páginas intuitívas, responsivas, objetivas, funcionais e eficientes com tecnologias modernas que possam oferecer agradáveis interfaces e experiência de usuário.'}
                </StyledText>
            </StyledAboutText>
